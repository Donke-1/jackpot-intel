  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-gray-900/30 border border-gray-800 rounded-3xl p-8 text-center space-y-4">
          <div className="text-2xl font-black">You’re not signed in</div>
          <div className="text-gray-500 text-sm">
            Login to access your Home Console, cycles, and wallet.
          </div>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {loadingData ? (
          <div className="flex items-center justify-center py-16 text-gray-500">
            <Loader2 className="w-6 h-6 animate-spin mr-2" /> Loading your console…
          </div>
        ) : (
          <>
            {/* Top tiles */}
              ...
              <div className="bg-gray-900/20 border border-gray-800 rounded-3xl p-6">
                ...
                <div className="mt-2 text-[12px] text-gray-500">
                  ...
                  <span className="text-white font-bold">
                    {fmtMoney(nextLock?.prize_pool ?? null, nextLock?.currency ?? 'KES')}
                  </span>
                </div>
                <div className="mt-4">
                  <Link href="/jackpots">
              ...
              <div className="bg-gray-900/20 border border-gray-800 rounded-3xl p-6">
                ...
                {latestSettled && bestSettlement ? (
                  ...
                  <>
                    ...
                    <div className="mt-2 text-[12px] text-gray-500">
                      Once jackpots are settled, proof shows up here automatically.
                    </div>
                  </>
                )}
              </div>
